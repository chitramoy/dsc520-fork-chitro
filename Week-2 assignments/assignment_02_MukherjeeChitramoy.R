...
theurl <- "C:/Users/chitro/Desktop/dsc520-fork-chitro"
dir(theurl)
dir(path = theurl, pattern = NULL, all.files = TRUE,
...
person_df1 <- read.csv(file  = 'C:/Users/chitro/Desktop/dsc520-fork-chitro/data/tidynomicon/person.csv', header=TRUE, sep=",")
str (person_df1)
...
person_df2 <- read.csv(file  = 'C:/Users/chitro/Desktop/dsc520-fork-chitro/data/tidynomicon/person.csv', stringsAsFactors=FALSE)
str (person_df2)

## Read the file `data/scores.csv` to `scores_df`
## Display summary statistics using the `summary()` function
scores_df <- read.csv( file = 'C:/Users/chitro/Desktop/dsc520-fork-chitro/data/scores.csv' , header=TRUE, sep =",")
summary(scores_df)
...
excel_sheets('C:/Users/chitro/Desktop/dsc520-fork-chitro/data/G04ResultsDetail2004-11-02.xls')
...
voter_turnout_df1 <- read_excel('C:/Users/chitro/Desktop/dsc520-fork-chitro/data/G04ResultsDetail2004-11-02.xls' , sheet='Voter Turnout')
...
voter_turnout_df2 <- read_excel('C:/Users/chitro/Desktop/dsc520-fork-chitro/data/G04ResultsDetail2004-11-02.xls' , sheet='Voter Turnout', skip = 2, col_names  =c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout"))
...
db <- dbConnect( RSQLite::SQLite() , 'C:/Users/chitro/Desktop/dsc520-fork-chitro/data/tidynomicon/example.db' )
